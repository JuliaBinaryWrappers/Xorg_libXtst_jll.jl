...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libXtst_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b6f176f1-7aea-5357-ad67-1d3e565ea1c6"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_libXtst; unsupported platform $(triplet(platform_key_abi()))")
else
